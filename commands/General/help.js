...
class Help extends Command {
	...
	async run (message, args, data) {
		...
		const embed = new Discord.MessageEmbed()
			...
			.setTimestamp()
			.setFooter(data.config.embed.footer, this.client.user.displayAvatarURL({ size: 512, dynamic: true, format: 'png' }));
		...
		embed.addField("\u200B", message.translate("misc:STATS_FOOTER", {
			...
			githubLink: "https://github.com/Tentennnn",
			supportLink: "https://discord.gg/8cNQb9rDue"
		}));
